...
class BeauvaisPageEn extends StatefulWidget {
  const BeauvaisPageEn({super.key});

  @override
  State<BeauvaisPageEn> createState() => _BeauvaisPageEnState();
}

class _BeauvaisPageEnState extends State<BeauvaisPageEn> {
